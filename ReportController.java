...
public class ReportController {
    ...
    private String currentReportFilterAttributeType; 
    ...
    // Metode utama untuk Use Case 'View Report List'
    public void handleReportMenu(User observerUser, Scanner scanner) {
        ...
        do {
            ...
            printMeasurementListDetailed(this.filteredMeasurementList); 
            ...
            System.out.println("3. View Measurement & Analysis (Partisipan Spesifik)"); 
            System.out.println("4. Kembali ke Dashboard Observer"); 
    ...
    public void handleViewMeasurement(User observerUser, Scanner scanner) {
        ...
        do {
            ...
            displayDetailedMeasurementList(this.measurementList); 
    ...
    // Metode : displayDetailedMeasurementList (untuk mencetak semua atribut)
    ...
    private void filterReportsMenu(Scanner scanner, int observerCompanyId) {
        ...
        do {
            ...
            System.out.println("5. Kembali ke Dashboard Laporan (Reset Filter)"); 
            System.out.print("Pilih opsi: ");
    ...
    // Metode : resetAttributeFilter
    private void resetAttributeFilter() {
        this.currentReportFilterAttributeType = null;
        this.currentReportFilterAttributeValue = null;
    }

    // Metode : displayCurrentReportFilters
    ...
    // Metode : applyFiltersToMeasurementList 
    ...
    // Metode : getUniqueDepartmentsInCompany (mengambil daftar departemen unik dari DB)
    ...
    // Metode : getParticipantDepartmentById (untuk mendapatkan departemen partisipan)
    ...
    // Metode : viewMeasurementsAndAnalysisForSpecificParticipant
    public void viewMeasurementsAndAnalysisForSpecificParticipant(int participantIdToView, User observerUser, Scanner scanner) { 
        ...
        loadMeasurementsFromDatabase(participantIdToView, observerCompanyId); 
        ...
        performAnalysisOnCurrentMeasurementList(); 

        System.out.println("\nTekan ENTER untuk kembali ke menu sebelumnya...");
        scanner.nextLine();
    }
    
    // Metode : performAnalysisOnCurrentMeasurementList (untuk analisis dari list yang sudah dimuat)
    ...
    // Metode : showAnalysisReportOverall (Analisis untuk Seluruh Perusahaan)
    public void showAnalysisReportOverall(User observerUser) {
        ...
        performAnalysisOnCurrentMeasurementList(); // Lakukan analisis pada list 
    }
